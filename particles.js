var pJS = function (e, t) {
    ...
    this.pJS = {
        ...
        particles: {
            ...
            move: { enable: true, speed: 2, direction: "none", random: false, straight: false, out_mode: "out", bounce: false, attract: { enable: false, rotateX: 3e3, rotateY: 3e3 } },
            array: [],
        },
        interactivity: {
            detect_on: "canvas",
    ...
    t && Object.deepExtend(m, t),
        ...
        (m.fn.retinaInit = function () {
            m.retina_detect && 1 < window.devicePixelRatio ? ((m.canvas.pxratio = window.devicePixelRatio), (m.tmp.retina = true)) : ((m.canvas.pxratio = 1), (m.tmp.retina = false)),
        ...
        (m.fn.particle = function (e, t, a) {
            if (
                ...
                m.particles.size.anim.enable && ((this.size_status = false), (this.vs = m.particles.size.anim.speed / 100), m.particles.size.anim.sync || (this.vs = this.vs * Math.random())),
            ...
            (this.opacity = (m.particles.opacity.random ? Math.random() : 1) * m.particles.opacity.value),
                m.particles.opacity.anim.enable && ((this.opacity_status = false), (this.vo = m.particles.opacity.anim.speed / 100), m.particles.opacity.anim.sync || (this.vo = this.vo * Math.random()));
            var s = {};
            ...
            if ("image" == this.shape) {
                ...
                (this.img = { src: c.image.src, ratio: c.image.width / c.image.height }),
                    ...
                    "svg" == m.tmp.img_type && null != m.tmp.source_svg && (m.fn.vendors.createSvgImg(this), m.tmp.pushing && (this.img.loaded = false));
            }
        }),
        (m.fn.particle.prototype.draw = function () {
            ...
            switch (((m.canvas.ctx.fillStyle = i), m.canvas.ctx.beginPath(), e.shape)) {
                case "circle":
                    m.canvas.ctx.arc(e.x, e.y, t, 0, 2 * Math.PI, false);
                    break;
                case "edge":
            ...
            for (var e = 0; e < m.particles.array.length; e++) {
                ...
                if (
                    (m.particles.opacity.anim.enable &&
                        (1 == t.opacity_status
                            ? (t.opacity >= m.particles.opacity.value && (t.opacity_status = false), (t.opacity += t.vo))
                            : (t.opacity <= m.particles.opacity.anim.opacity_min && (t.opacity_status = true), (t.opacity -= t.vo)),
                        t.opacity < 0 && (t.opacity = 0)),
                    m.particles.size.anim.enable &&
                        (1 == t.size_status ? (t.radius >= m.particles.size.value && (t.size_status = false), (t.radius += t.vs)) : (t.radius <= m.particles.size.anim.size_min && (t.size_status = true), (t.radius -= t.vs)),
                ...
                if (
                    (-1 < m.interactivity.events.onhover.mode.indexOf("grab") && m.fn.modes.grabParticle(t),
                    (-1 < m.interactivity.events.onhover.mode.indexOf("bubble") || -1 < m.interactivity.events.onclick.mode.indexOf("bubble")) && m.fn.modes.bubbleParticle(t),
                    (-1 < m.interactivity.events.onhover.mode.indexOf("repulse") || -1 < m.interactivity.events.onclick.mode.indexOf("repulse")) && m.fn.modes.repulseParticle(t),
        ...
        (m.fn.particlesRefresh = function () {
            cancelRequestAnimFrame(m.fn.checkAnimFrame),
                ...
                (m.tmp.source_svg = undefined),
                (m.tmp.img_obj = undefined),
                (m.tmp.count_svg = 0),
                m.fn.particlesEmpty(),
                m.fn.canvasClear(),
                m.fn.vendors.start();
        ...
        (m.fn.modes.pushParticles = function (e, t) {
            ...
            for (var a = 0; a < e; a++)
                m.particles.array.push(new m.fn.particle(m.particles.color, m.particles.opacity.value, { x: t ? t.pos_x : Math.random() * m.canvas.w, y: t ? t.pos_y : Math.random() * m.canvas.h })),
                    a == e - 1 && (m.particles.move.enable || m.fn.particlesDraw(), (m.tmp.pushing = false));
        }),
        ...
        (m.fn.modes.bubbleParticle = function (c) {
            if (m.interactivity.events.onhover.enable && -1 < m.interactivity.events.onhover.mode.indexOf("bubble")) {
            ...
            } else if (m.interactivity.events.onclick.enable && -1 < m.interactivity.events.onclick.mode.indexOf("bubble")) {
                if (m.tmp.bubble_clicking) {
                    ...
                    l > m.interactivity.modes.bubble.duration && (m.tmp.bubble_duration_end = true), l > 2 * m.interactivity.modes.bubble.duration && ((m.tmp.bubble_clicking = false), (m.tmp.bubble_duration_end = false));
                }
                function v(e, t, a, i, s) {
                    if (e != t)
                        ...
                        } else "size" == s && (c.radius_bubble = undefined), "opacity" == s && (c.opacity_bubble = undefined);
                }
        ...
        (m.fn.modes.repulseParticle = function (i) {
            if (m.interactivity.events.onhover.enable && -1 < m.interactivity.events.onhover.mode.indexOf("repulse") && "mousemove" == m.interactivity.status) {
                var e = i.x - m.interactivity.mouse.pos_x,
                    t = i.y - m.interactivity.mouse.pos_y,
                    a = Math.sqrt(e * e + t * t),
                    s = e / a,
                    n = t / a,
                    r = Math.min(Math.max((1 / (o = m.interactivity.modes.repulse.distance)) * (-1 * Math.pow(a / o, 2) + 1) * o * 100, 0), 50),
            ...
            } else if (m.interactivity.events.onclick.enable && -1 < m.interactivity.events.onclick.mode.indexOf("repulse"))
                if ((m.tmp.repulse_finish || (m.tmp.repulse_count++, m.tmp.repulse_count == m.particles.array.length && (m.tmp.repulse_finish = true)), m.tmp.repulse_clicking)) {
                        ...
                        if (
                            ...
                            switch (m.interactivity.events.onclick.mode) {
                                ...
                                case "remove":
                                    ...
                                    break;
                                case "bubble":
                                    m.tmp.bubble_clicking = true;
                                    break;
                                case "repulse":
                                    (m.tmp.repulse_clicking = true),
                                        (m.tmp.repulse_count = 0),
                                        (m.tmp.repulse_finish = false),
                                        setTimeout(function () {
                                            m.tmp.repulse_clicking = false;
        ...
        (m.fn.vendors.createSvgImg = function (n) {
            ...
            s.addEventListener("load", function () {
                (n.img.obj = s), (n.img.loaded = true), a.revokeObjectURL(i), m.tmp.count_svg++;
            }),
                (s.src = i);
        }),
        ...
        (m.fn.vendors.loadImg = function (e) {
            if (((m.tmp.img_error = undefined), "" != m.particles.shape.image.src))
                if ("svg" == e) {
                    var t = new XMLHttpRequest();
                    t.open("GET", m.particles.shape.image.src),
                        (t.onreadystatechange = function (e) {
                            4 == t.readyState && (200 == t.status ? ((m.tmp.source_svg = e.currentTarget.response), m.fn.vendors.checkBeforeDraw()) : (console.log("Error pJS - Image not found"), (m.tmp.img_error = true)));
                        }),
                        t.send();
                } else {
                    var a = new Image();
            ...
            else console.log("Error pJS - No image.src"), (m.tmp.img_error = true);
        }),
        ...
        (m.fn.vendors.start = function () {
            -1 < m.particles.shape.type.indexOf("image") ? ((m.tmp.img_type = m.particles.shape.image.src.substr(m.particles.shape.image.src.length - 3)), m.fn.vendors.loadImg(m.tmp.img_type)) : m.fn.vendors.checkBeforeDraw();
        }),
